...
```rust
src-tauri/src/
├── lib.rs               # Main entry point and Tauri setup
├── db.rs                # Database operations and connection pooling
├── auth.rs              # Authentication and password hashing
├── models/              # Data models and structures
│   ├── show.rs          # Show model and data types
│   ├── wrestler.rs      # Wrestler model and data types
│   ├── title.rs         # Title model and data types
│   └── user.rs          # User model and authentication
